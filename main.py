...
from favourite import addStockList, clearStocks, getStockList,setTopList
...
if __name__ == '__main__':
    ...
    list = getLatestValidJson(userId)
    
    result = diff(list[-2], list[-1])

    setTopList(','.join(result))
    ...
    #     stocks = filterStocks(group["userId"], group["groupId"])
